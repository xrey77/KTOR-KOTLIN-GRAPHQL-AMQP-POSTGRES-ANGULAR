...
interface ProductRepository {
    ...
    suspend fun findProducts(page: Int): PagedResponse
    suspend fun searchProducts(page: Int, descriptions: String): PagedResponse
...
class ProductRepositoryImpl : ProductRepository {
    ...
    override suspend fun findProducts(page: Int): PagedResponse {
        val pageSize = 5
    ...
    override suspend fun searchProducts(page: Int, descriptions: String): PagedResponse {
        val pageSize = 5
        val calculatedOffset = ((page - 1) * pageSize).toLong()
